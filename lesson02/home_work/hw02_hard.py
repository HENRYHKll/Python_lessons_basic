...
equation = 'y = -12x + 11111140.2121'
x = 2.5
xx_x = equation.find('x')
xx_k = equation.find('=') + 1
if (equation[xx_k]) == '-':
    sign1 = -1
else:
    sign1 = 1
coeff_k = float(equation[xx_k:xx_x]) * sign1
b = float(equation[xx_x + 4:])
y = coeff_k * x + b
print("У равна:",y)
...
date = input("Введите день в формате dd.mm.yyyy, например: 12.04.1961.: ")
